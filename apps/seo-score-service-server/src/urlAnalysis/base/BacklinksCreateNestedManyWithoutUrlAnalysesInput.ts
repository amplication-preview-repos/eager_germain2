...
@InputType()
class BacklinksCreateNestedManyWithoutUrlAnalysesInput {
...
export { BacklinksCreateNestedManyWithoutUrlAnalysesInput as BacklinksCreateNestedManyWithoutUrlAnalysesInput };
